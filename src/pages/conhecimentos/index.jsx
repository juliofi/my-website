    ...
    <div className={styles.conhecimentosContainer}>
      ...
      <div className={styles.bodyContainer}>
        <div className={styles.titulos}>
          ...
          <Titulo margem="630px" titulo="Férias" subtitulo="13/12/2023" />
          <Titulo margem="672px" titulo="AGES" subtitulo="26/02/2024" />
          <Titulo margem="668px" titulo="Rocketseat" subtitulo="23/03/2024" />
        ...
        <div className={styles.line}>
          ...
          <Bolinha margem="678px" />
          <Bolinha margem="730px" />
          <Bolinha margem="730px" />
          <Bolinha margem="670px" />
